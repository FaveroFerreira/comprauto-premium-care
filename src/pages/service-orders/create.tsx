...
import type { CreateServiceOrderInput, LaborTask, PartItem, Part } from '@/types';
...
export default function ServiceOrdersCreatePage() {
  ...
  const mutation = useMutation({
    mutationFn: (data: CreateServiceOrderInput) => serviceOrdersApi.create(data),
    onSuccess: () => {
